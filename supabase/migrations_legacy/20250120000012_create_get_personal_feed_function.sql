-- Create get_personal_feed function for personalized feed queries
-- Returns feed items filtered and scored based on user interests
-- Security: Only allows users to query their own feed (auth.uid() check)
